      ...
      <div className="aui-thread-welcome-center flex w-full grow flex-col items-center justify-center">
        <div className="aui-thread-welcome-message flex size-full flex-col justify-center px-8">
          ...
          <div className="aui-thread-welcome-message-inner fade-in slide-in-from-bottom-2 animate-in text-2xl text-muted-foreground/65 delay-100 duration-300 ease-out">
            Bring a launch handoff, repo change, or knowledge thread.
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="aui-thread-welcome-suggestions grid w-full grid-cols-1 gap-2 pb-2 sm:grid-cols-2">
      {[
        {
          title: "Review",
          label: "the launch handoff",
          action:
            "Review the Pandora node launch handoff and list the remaining gates",
        },
        {
          title: "Summarize",
          label: "this node repo",
          action: "Summarize the Pandora node repo and its launch-critical files",
        },
